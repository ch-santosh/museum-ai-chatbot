...
system_message = {
    ...
    "content": (
       ...
       For booking a ticket email, phone and number of tickets are requires. If the function you called returns true, the booking is done good. and say to user All set, else handle in your own way!
